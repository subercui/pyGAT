...
datafile='GBsleep.edf'
hfofiles=['GBsleep.pik','fastripple_dets.pik']
#
# datafile='/home/freesurfer/Documents/3data/doctor_zhang/jiangweiwei/JIANGWEIWEI_IID.edf'
# hfofiles=['/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/jangweiwei/ripple_dets.pik','/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/jangweiwei/fastripple_dets.pik']

# datafile='/home/freesurfer/Documents/3data/doctor_zhang/shenjing/SHENJING_IID.edf'
# hfofiles=['/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/shenjing/ripple_dets.pik','/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/shenjing/fastripple_dets.pik']

# datafile='/home/freesurfer/Documents/3data/doctor_zhang/tianmiuting/tianmiuting_IID.edf'
# hfofiles=['/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/tianmiuting/ripple_dets.pik','/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/tianmiuting/fastripple_dets.pik']

# datafile='/home/freesurfer/Documents/3data/doctor_zhang/yangying/YANGYING_IID.edf'
# hfofiles=['/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/yangying/ripple_dets.pik','/home/freesurfer/Documents/3data/doctor_zhang/cui_dets/yangying/fastripple_dets.pik']
...
class plot_hfo_spec(object):
    def __init__(self,fig_canvas,ax,hfo_times,hfo_signals,hfo_chans,raw_chn_names,hfo_xy,filter_bank='ripple'):
    ...
    def button_press_func(self,e):
        ...
        if e.button==3:
            ...
            ax_spec.cla()
            f,t,hfo_spec=sig.spectrogram(self.press_hfo_signal,fs=sfreq,nperseg=int(0.4*half_width),noverlap=int(0.4*half_width-1),nfft=8084,mode='magnitude')
...
for i in range(len(all_raw_chn_names[0])):
    ...
    ripple_ax.text(0,plotgap*(all_chn_nums[0]-1-i),all_raw_chn_names[0][i],horizontalalignment='right',verticalalignment='center',color='r' if i%2==0 else 'b')
for i in range(len(all_hfo_chans[0])):
    ripple_ax.plot(all_hfo_times[0][i],all_hfo_signals[0][i]+plotgap*(all_chn_nums[0]-1-all_hfo_chans[0][i]),color='r' if all_hfo_chans[0][i]%2==0 else 'b')
...
ripple_show_hfo=plot_hfo_spec(ripple_fig.canvas,ripple_ax,all_hfo_times[0],all_hfo_signals[0],all_hfo_chans[0],all_raw_chn_names[0],all_hfo_xy[0],'ripple')

fastripple_fig=plt.figure('fast ripple')
...
for i in range(len(all_raw_chn_names[1])):
    ...
    fastripple_ax.text(0,plotgap*(all_chn_nums[1]-1-i),all_raw_chn_names[1][i],horizontalalignment='right',verticalalignment='center',color='r' if i%2==0 else 'b')
for i in range(len(all_hfo_chans[1])):
    fastripple_ax.plot(all_hfo_times[1][i],all_hfo_signals[1][i]+plotgap*(all_chn_nums[1]-1-all_hfo_chans[1][i]),color='r' if all_hfo_chans[1][i]%2==0 else 'b')
...
fastripple_show_hfo=plot_hfo_spec(fastripple_fig.canvas,fastripple_ax,all_hfo_times[1],all_hfo_signals[1],all_hfo_chans[1],all_raw_chn_names[1],all_hfo_xy[1],'fast ripple')
